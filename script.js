...
const resultContent = [
  { label: "カラ周り", name: "ハムスター", image: "assets/hamster-karamawari.png", alt: "カラ周りハムスター", stats: [90, 5, 25], tags: ["#毎日コツコツ", "#調べすぎ迷子", "#がんばり損"], description: "節約やポイ活にはとっても前向き！<br>でも、お得な方法を調べたり、いろいろ試したりするうちに、手間ばかり増えているかも。頑張る量を増やすより、効果の高い方法をひとつに絞ることが、貯まる近道です。" },
  { label: "記憶喪失の", name: "カラス", image: "assets/crow-kiokusoushitsu.png", alt: "記憶喪失のカラス", stats: [35, 20, 15], tags: ["#いつの間にか", "#少額の積み重ね", "#記録がカギ"], description: "日々のお買い物を自然体で楽しめるタイプ。<br>ただ、ひとつひとつは小さな出費でも、振り返ると大きくなっていることがありそう。まずは使った金額を見える化するだけで、無理なく貯まりやすくなります。" },
  { label: "ごほうび依存の", name: "トイプー", image: "assets/toypoodle-gohoubi.png", alt: "ごほうび依存のトイプー", stats: [65, 35, 70], tags: ["#自分にごほうび", "#今を楽しむ", "#先取りがカギ"], description: "頑張った分だけ、自分を喜ばせることを大切にできるタイプ。<br>楽しみを全部我慢する必要はありません。使う前に少しだけ貯める仕組みを作れば、ごほうびも貯金も両立しやすくなります。" },
  { label: "ミーハーな", name: "ミーアキャット", image: "assets/meerkat-miihaa-final.png", alt: "ミーハーなミーアキャット", stats: [80, 40, 55], tags: ["#新しいもの好き", "#限定に弱い", "#予算で安心"], description: "新しいサービスや話題の商品を見つけるのが得意なタイプ。<br>好奇心はそのままに、使ってよい金額を先に決めておくのがおすすめ。予算の中なら、罪悪感なくトレンドを楽しめます。" },
];
